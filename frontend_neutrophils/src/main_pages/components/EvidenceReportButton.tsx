...
export interface EvidenceReportButtonProps { onAccept: any, onDisagree: any, dataID: any, buttonDivStyle: any};
...
export default class EvidenceReportButtons extends React.Component<EvidenceReportButtonProps, EvidenceReportButtonState>{
    ...
    render(){
        ...
        console.log("Button Stye");
        console.log(this.props.buttonDivStyle);

        if (this.props.buttonDivStyle)
        {
            buttonStyle = this.props.buttonDivStyle;
