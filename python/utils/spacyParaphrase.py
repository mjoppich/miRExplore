...
if __name__ == '__main__':
    texts = [
        "One potential microRNA that regulates Bcan is miR-9, and overexpression of miR-9 can partly rescue the effects of Dicer1 deletion on the MG phenotype."
        ]
    ...
    def print_paraphrase(text):
        ...
        doc = nlp(text)
        perturbed_text = perturb_text(doc, verbose=False, use_typos=False)
