...
#https://raw.githubusercontent.com/NSchrading/intro-spacy-nlp/master/subject_object_extraction.py
...
def testSVOs():
    ...
    userMirs = ['miR-150-5p', 'miR-150-3p', 'miR-195-5p', 'miR-486-5p', 'miR‑186', 'miR-9']
    ...
    tok = nlp("One potential microRNA that regulates Bcan is miR-9, and overexpression of miR-9 can partly rescue the effects of Dicer1 deletion on the MG phenotype.")
    svos = findSVOs(tok)
    printDeps(tok)
    print(svos)
